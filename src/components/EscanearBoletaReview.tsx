// src/components/EscanearBoletaReview.tsx
...
const EscanearBoletaReview: React.FC<Props> = ({
  archivos,
  onAddMore,
  onRemove,
  onGuardar,
  ...
  <div className="max-w-md mx-auto text-center pb-24">
    <h2 className="text-xl font-bold text-blue-800 mb-6">Escanear Boleta</h2>
...
export default EscanearBoletaReview;
