// src/components/SubirArchivoBoletaImagenDocumento.tsx
...
const SubirArchivoBoletaImagenDocumento: React.FC<Props> = ({ onVolver }) => {
...
export default SubirArchivoBoletaImagenDocumento;
